...
@register_policy_loss("gppo_erc")
def compute_policy_loss_gppo_erc(
    ...
    )  # - clip(ratio, (1-cliprange)*ratio/ratio.detach(), (1+cliprange)*ratio/ratio.detach()) * A
