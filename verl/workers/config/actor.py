...
class ActorConfig(BaseConfig):
    ...
    entropy_mask_high: float = 1.2,
    entropy_mask_low: float = 0.8,
    postive_loss_coeff: float = 0.1,
    probs_coeff: float = 0.2,
    probs_coeff_low: float = 0.2
    probs_coeff_high: float = 0.8
