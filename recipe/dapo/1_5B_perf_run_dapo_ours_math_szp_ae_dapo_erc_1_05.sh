...
YOUR_TEST_FILE='[data/aime960_math_verify25_uni.json,data/aime960_math_verify_uni.json]'
project_name='gppo'

exp_name='distill_1_5_B_ae_dapo_v1_math_bal_norm_v2_1_05'
...
/share/miniconda3/envs/verl_szp_py310/bin/ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    --working-dir "${WORKING_DIR}" \
    -- /share/miniconda3/envs/verl_szp_py310/bin/python -m recipe.dapo.main_dapo \
    ...
    actor_rollout_ref.actor.policy_loss.loss_mode="grpo_erc" \
